...
(function (a) {
    a.fn.visualLightbox = function (ah) {
        ...
        ah = a.extend({animate: true, autoPlay: true, borderSize: 39, containerID: document, enableSlideshow: true, googleAnalytics: false, descSliding: true, imageDataLocation: "south", shadowLocation: "", closeLocation: "", pauseLocation: "", initImage: "", loop: true, overlayDuration: 0.2, overlayOpacity: 0.7, prefix: "", classNames: "photo_img", resizeSpeed: 7, showGroupName: false, slideTime: 4, strings: {closeLink: "", loadingMsg: "loading", nextLink: "", prevLink: "", startSlideshow: "", stopSlideshow: "", numDisplayPrefix: "", numDisplaySeparator: "/"}, openByHover: false, enableRightClick: false, featBrowser: true, breathingSize: 10, startZoom: false, floating: true}, ah);
        if (ah.animate) {
        ...
        var q = this.start = function (c) {
            ...
            c = a(c);
            av = c.get(0);
            aX("overlay").css({height: O()[1] + "px", top: 0, left: i().x + "px"});
            if (ah.descSliding) {
        ...
        function aD(t, be) {
            ...
            if (t == true) {
                ...
                if (ah.floating) {
                    ...
                    aX("lightbox").css({top: "90px", left: c + "px"})
                }
            } else {
        ...
        function L(a6, a1, a4, a5, a0, a7, a2) {
            ...
            h(t, a6, a1, a0);
            if (ah.startZoom && !a2) {
                c.animate(a.extend({opacity: 0}, a7 < 1 ? {height: "120%", top: "-10%", left: (100 - 120 / a7) / 2 + "%"} : {width: "120%", left: "-10%", top: (100 - a7 * 120) / 2 + "%"}), {queue: false, duration: aQ * 1000, complete: function () {
                    a(this).remove()
                }});
                d.animate(a.extend({left: 0, top: 0}, a7 < 1 ? {width: "100%"} : {height: "100%"}), {queue: false, duration: aQ * 1000})
            }
            a3.animate({width: a4 + "px", height: a5 + "px"}, {queue: false, duration: aQ * 1000, complete: !a2 ? function () {
                aU()
            } : null})
        }
        ...
        function aU() {
            ...
            if (ah.startZoom) {
                ...
                aX("lightboxImage").css({opacity: 0}).show().fadeTo(500, 1, function () {
                    aN()
                })
            }
            E()
        ...
        function x() {
            ...
            if (e.length > 1) {
                ...
                aX("slideShowControl").css({display: "none"})
            }
        }
        ...
        function aN() {
            x();
            if (ah.descSliding) {
                aX("imageDataContainer").animate({height: "show", opacity: "show"}, 650, null, function () {
                    C()
                })
            } else {
                C()
        ...
        function ax(c) {
            if (ah.descSliding) {
                aX("imageDataContainer").animate({height: "hide", opacity: "hide"}, 650, null, function () {
                    g(c)
                })
            } else {
                g(c)
