...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'information_mainpage', 'body', self.gf('django.db.models.fields.TextField')())

        # Changing field 'MainPage.body_ru'
        db.alter_column(u'information_mainpage', 'body_ru', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'MainPage.body_en'
        db.alter_column(u'information_mainpage', 'body_en', self.gf('django.db.models.fields.TextField')(null=True))
