...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'information_news', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['information.News']))
        ...
        # Changing field 'UsefullInformation.parent'
        db.alter_column(u'information_usefullinformation', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['information.UsefullInformation']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UsefullInformation.parent'
        db.alter_column(u'information_usefullinformation', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['information.UsefullInformation'], null=True))
