...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gallery_videofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.VideoGallery'])),
            ('file', self.gf('django.db.models.FileField')(max_length=100)),
            ('type', self.gf('django.db.models.fields.CharField')(default='video/mp4', max_length=15)),
        ))
        db.send_create_signal(u'gallery', ['VideoFile'])


    def backwards(self, orm):
        # Deleting model 'VideoFile'
        db.delete_table(u'gallery_videofile')
    ...
    models = {
        ...
        u'gallery.videofile': {
            ...
            'file': ('django.db.models.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'video/mp4'", 'max_length': '15'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gallery.VideoGallery']"})
        },
