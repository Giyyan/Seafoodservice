...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certificate.title'
        db.add_column(u'certificates_certificate', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Certificate.title'
        db.delete_column(u'certificates_certificate', 'title')
